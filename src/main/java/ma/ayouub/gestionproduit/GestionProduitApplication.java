package ma.ayouub.gestionproduit;

import ma.ayouub.gestionproduit.entities.Product;
import ma.ayouub.gestionproduit.repository.ProductRepository;
...
public class GestionProduitApplication implements CommandLineRunner {
	...
	public static void main(String[] args) {
		SpringApplication.run(GestionProduitApplication.class, args); // si je demaree cett app le premier qui demaree c est spring
